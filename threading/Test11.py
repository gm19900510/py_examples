...
def do(i, filelist):  
    with open("F://face//" + str(filelist[i]), 'rb') as f:  # 以二进制读取图片
        data = f.read()
    ...
    r = requests.post('http://192.168.3.209:8080/v4/photos', data=postdata, headers=headers)
    print(r.text)
